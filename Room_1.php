...
<h1>Facilities designed to live with joy</h1>
    ...
    <nav>
    <h1>Single bed/ Bedroom</h1>
    
    </nav>
   <main class="parent">
       <section>
        <img src="images/38548471-1024x683.jpg", height="400" alt=" Image Coming">
       </section>
       
       <section  class="child">
       <h1><br>Single rooms are assigned to one person or a couple.<br>Condition: AC<br>Number of Bed: 1<br>
        Max People: 2<br>Food: Not Available<br><br>Price: 800 BDT</h1>
