...
<h1>Facilities designed to live with joy</h1>
    ...
    <nav>
    <h1>Double bed/ Bedroom</h1>
    
    </nav>
   <main class="parent">
       <section>
        <img src="images/22_DDNS1.jpg", height="400" alt=" Image Coming">
       </section>
       
       <section  class="child">
       <h1><br>Double bed/ bedrooms can have multiple Persons.<br>Condition: AC<br>Number of Bed: 2<br>
        Max People: 4<br>Food: Not Available<br><br>Price: 1500 BDT</h1>
